...
📅 週間予報
6/11(木) 一部曇り 23.5℃/16.7℃ ☔29%
6/12(金) 小雨 26.5℃/18.1℃ ☔98%
6/13(土) 曇り 27.7℃/18.9℃ ☔20%
6/14(日) 小雨 25.8℃/17.6℃ ☔35%
6/15(月) 小雨 24.7℃/17.9℃ ☔89%
6/16(火) 曇り 25.8℃/17.3℃ ☔16%

🤖 天気予報botからのひと言:
今日の渋谷区は小雨が降ったり止んだりの一日となりそうです。降水確率
78%と高めですので、お出かけの際はどうぞ傘をお忘れなく。
```
...
- **天気・降水確率・週間予報の取得**：Open-Meteo API から当日の天気・最高/最低気温・降水確率に加え、これから 6 日間の週間予報を取得して通知
- **AI によるひと言生成**：天気データ（降水確率を含む）を Gemini に渡し、アナウンサー調の柔らかいアドバイスを自動生成（雨の日は傘をやさしく案内）
